...
"""
Genera datos realistas y ejecuta la pipeline completa para el Día 4 (2026-06-04).

Uso (Docker):
    docker compose exec backend python manage.py seed_day_4
    docker compose exec backend python manage.py seed_day_4 --skip-audit
"""
...
class Command(BaseCommand):
    help = "Genera datos y carga el pipeline completo para el Día 4 (2026-06-04)."
