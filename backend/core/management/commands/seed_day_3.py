...
"""
Genera datos realistas y ejecuta la pipeline completa para el Día 3 (2026-06-03).

Uso (Docker):
    docker compose exec backend python manage.py seed_day_3
    docker compose exec backend python manage.py seed_day_3 --skip-audit
"""
...
class Command(BaseCommand):
    help = "Genera datos y carga el pipeline completo para el Día 3 (2026-06-03)."
