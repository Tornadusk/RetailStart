...
"""
Genera datos realistas y ejecuta la pipeline completa para el Día 2 (2026-06-02).

Uso (Docker):
    docker compose exec backend python manage.py seed_day_2
    docker compose exec backend python manage.py seed_day_2 --skip-audit
"""
...
class Command(BaseCommand):
    help = "Genera datos y carga el pipeline completo para el Día 2 (2026-06-02)."
