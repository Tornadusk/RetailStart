...
"""
Genera datos realistas y ejecuta la pipeline completa para el Día 1 (2026-06-01).

Uso (Docker):
    docker compose exec backend python manage.py seed_day_1
    docker compose exec backend python manage.py seed_day_1 --skip-audit
"""
...
class Command(BaseCommand):
    help = "Genera datos y carga el pipeline completo para el Día 1 (2026-06-01)."
